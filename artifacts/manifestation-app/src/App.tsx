...
const clerkAppearance = {
  ...
  elements: {
    ...
    card: "!shadow-none !border-0 !bg-transparent !rounded-none !w-full !max-w-full !overflow-hidden",
    main: "!w-full !max-w-full !overflow-hidden",
    form: "!w-full !max-w-full",
    footer: "!shadow-none !border-0 !bg-transparent !rounded-none !w-full !max-w-full",
    ...
    formButtonPrimary: "font-mono font-semibold tracking-wide !w-full !max-w-full",
